...
.odv-markdown h1{font-size:1.9em;padding-bottom:.3em;border-bottom:1px solid #e2e5ea}
.odv-markdown h2{font-size:1.5em;padding-bottom:.3em;border-bottom:1px solid #e2e5ea}
.odv-markdown h3{font-size:1.25em}
.odv-markdown p,.odv-markdown ul,.odv-markdown ol,.odv-markdown blockquote{margin:0 0 1em}
.odv-markdown a{color:#2257d6;text-decoration:none}
.odv-markdown a:hover{text-decoration:underline}
.odv-markdown code{background:#f1f3f6;border-radius:5px;padding:.15em .4em;font-size:.88em;
  font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}
.odv-markdown pre{background:#f6f8fa;border:1px solid #e2e5ea;border-radius:8px;padding:14px 16px;
  overflow:auto}
.odv-markdown pre code{background:none;padding:0}
.odv-markdown blockquote{padding:0 1em;color:#57606a;border-left:.25em solid #d0d7de}
.odv-markdown img{max-width:100%}
.odv-markdown table{border-collapse:collapse;margin:0 0 1em;display:block;overflow:auto}
.odv-markdown th,.odv-markdown td{border:1px solid #d0d7de;padding:6px 13px}
.odv-markdown th{background:#f6f8fa;font-weight:600}
.odv-markdown hr{height:1px;background:#e2e5ea;border:0;margin:1.5em 0}
`

let markdownStylesInjected = false
function injectMarkdownStyles(): void {
  if (markdownStylesInjected || typeof document === 'undefined') return
  const el = document.createElement('style')
  el.id = 'odv-markdown-styles'
